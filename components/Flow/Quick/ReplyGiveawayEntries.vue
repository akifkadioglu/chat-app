	...
	<div class="w-full">
		<div class="p-5">
			<div class="space-y-10" v-auto-animate>
				...
				<FirstDMActionPanel :showAskForEmailDM="false" :flow="flowStore.flow" v-if="1 <= step">
					<template #default="{ isPrivateReplyNodeActive, lastNode, lastNodeGuard, requireOpeningDM }">
						<FollowUpMessage
							:isPrivateReplyNodeActive="isPrivateReplyNodeActive"
							:lastNodeBeforeFinalMessageNode="lastNode"
							:lastNodeBeforeFinalMessageNodeGuard="lastNodeGuard"
